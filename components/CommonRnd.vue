<template>
  <div class="rnd-content">
    <div class="top">
      <em class="ko">{{ rndItems.smk }}</em>
      <em class="en">{{ rndItems.sme }}</em>
      <span class="ko" v-html="rndItems.ko"></span>
      <span class="en" v-html="rndItems.en"></span>
    </div>
    <!-- //top -->
...
.cont dl {
  @apply flex flex-col mt-10 w-full gap-1;
}
.cont dl dt {
